package returnShoppingCartInfoServlet;
...
/**
 * Servlet implementation class ReturnShoppingCartInfoServlet
 */
@WebServlet(description = "返回购物车信息", urlPatterns = { "/returnShoppingCartInfoServlet" })
public class ReturnShoppingCartInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReturnShoppingCartInfoServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ...
		 BufferedReader read = request.getReader();
			...
			String sql = String.format("select b.id,b.name,b.img,b.zpmcc,b.price,a.amount from %s a inner join %s b where a.sp_ID = b.ID and a.user_phone = '%s' order by a.id desc ",
					
					DBNames.Table_ShoppingCar,
					DBNames.Table_SP,
					user_phone);
			System.out.println(sql);
