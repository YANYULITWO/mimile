package returnBrowsingHistoryServlet;
...
/**
 * Servlet implementation class ReturnBrowsingHistoryServlet
 */
@WebServlet(description = "返回浏览记录", urlPatterns = { "/returnBrowsingHistoryServlet" })
public class ReturnBrowsingHistoryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReturnBrowsingHistoryServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 BufferedReader read = request.getReader();
			...
			//String sql = String.format("select id,name,img,zpmcc,price from %s where %s.%s ", args)
